...
static FuncMapType s_theFuncList[] = 
{
		...
		{"readHexString",	(void *)readHexString,		"int readHexString(const char *lpszBuffer = \"23 12 9a ba 08 00\", UINT8 *pucData, int nLen)"	},
#if 0		
...
#endif		
		{"d", 				(void *)d,					"void d(void *pAddr, int nByteCount, int nWidth = [4|2|1], int nDisplayOffset"						},
		{"m",				(void *)m,					"void m(void *pAddr, int nWidth = [4|2|1]"						},
...
#endif
		{"set32", 			set32,			"void set32(UINT32 *pulAddr, UINT32 ulData);"},
		{"set16", 			set16,			"void set16(UINT16 *pusAddr, UINT16 usData);"},
		{"set8", 			set8,			"void set8(UINT8 *pucAddr, UINT8 ucData);"},
#if 0
...
void addFunctionMap(FuncMapType *pFuncMap, int nCount)
{
	...
	pNewMap = (FuncMapType *)malloc(sizeof(FuncMapType) * (g_FuncMapCount + nCount));
