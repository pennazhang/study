...
#include "dcDaemon_adaptor.h"

class DcDaemonServer :
  public com::harman::jetstream::dcDaemon_adaptor,
  public DBus::IntrospectableAdaptor,
  public DBus::ObjectAdaptor
{
public:

	DcDaemonServer(DBus::Connection &connection, const char * objectPath);

    /* For config function from commonInterface.xml */
...
extern DcDaemonServer *g_pDcDaemonServer;
