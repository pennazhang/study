...
// 
// we must call this function before any SSL operation.
// Return Value:  0 - initialized successfully.   -1 - initialized failed.
extern STATUS initCTX();

//
// Release the context.
extern void exitCTX(void);
