...
//!
//! Make sure use global variable or static variable as less as possible.
//! We should support multi-thread function at any time!
//!
...
void DCSettings::getStatus(std::string& outputInfo)
{
    outputInfo = "ConnectFlag:true";
    return;
}
