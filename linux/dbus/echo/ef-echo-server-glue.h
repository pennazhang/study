...
#ifndef __dbusxx__ef_echo_server_glue_h__ADAPTOR_MARSHAL_H
#define __dbusxx__ef_echo_server_glue_h__ADAPTOR_MARSHAL_H
...
public:
    ...
    virtual std::string Echo(const std::string& input) = 0;
...
public:
     ...
     */
    void Echoed(const std::string& arg1)
    {
...
#endif //__dbusxx__ef_echo_server_glue_h__ADAPTOR_MARSHAL_H
