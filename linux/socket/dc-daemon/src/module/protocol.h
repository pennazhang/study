...
public:
    ...
    std::string executeNextCommand();

protected:
    int m_channelID;
    std::string m_currentCommand;
    TimePoint m_commandStartPoint;
    bool m_commandRunningFlag;
...
{
public:
    Protocol(std::string protocolName);
    virtual ~Protocol();
    void dispatchChannelMessage(ChannelMessage& msg);
