...
char g_lpszFormatString[MAX_STRING_SIZE];

char * FormatString(UINT8 * pucMsg, int usLen)
{
    int ucCount = 0;
    int i;
	...
	ucCount = usLen;
	if (ucCount > MAX_STRING_SIZE / 3)
	{
		ucCount = MAX_STRING_SIZE / 3;
	}
