...
if [ ! -f /tmp/.debian_apt_done ]; then
    ...
    cd $DOCKER_CACHE_DIR
    sudo dpkg -i  linux-headers-4.9.40-3-rt30_1.2.studer.infinity_amd64.deb
    sudo dpkg -i  linux-image-4.9.40-3-rt30_1.2.studer.infinity_amd64.deb
    touch /tmp/.debian_apt_done
fi
