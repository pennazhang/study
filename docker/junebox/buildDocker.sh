...
PROJECT_NAME=junebox
GIT_REPO=ssh://git@bitbucket.harman.com:7999/jj/junebox.git
...
HOST_SRC_DIR=setupEnv
DOCKER_DST_DIR=setupEnv.tmp

#Auto run script in Docker to build environment
AUTO_START_DIR=/git/$PROJECT_NAME/$DOCKER_DST_DIR
