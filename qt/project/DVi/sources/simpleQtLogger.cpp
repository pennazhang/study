...
bool ENABLE_LOG_SINK_QDEBUG = true;
...
void logInit(QString strLogDirectory)
{
	...
	/* The role of default Log file is 'main'  */
    simpleqtlogger::SimpleQtLogger::createInstance(qApp)->setLogFormat_file("<TS> [<TID>] [<LL>] <TEXT> (<FUNC>@<FILE>:<LINE>)", "<TS> [<TID>] [<LL>] <TEXT>");
	simpleqtlogger::SimpleQtLogger::createInstance(qApp)->setLogFileName(strLogDirectory +"/DVi.log", 1000000, 2);
	...
	/* The role of 2nd file-log is 'warn'  */
	simpleqtlogger::SimpleQtLogger::getInstance()->addSinkFileLog("warn");
	simpleqtlogger::SimpleQtLogger::getInstance()->setLogFileName("warn", strLogDirectory + "/DViWarn.log", 1000000, 2);
