...
#define ENABLE_SQTL_LOG_SINK_CONSOLE   0   // 1: enable, 0: disable; log to console (colored log-levels)
#define ENABLE_SQTL_LOG_SINK_QDEBUG    1   // 1: enable, 0: disable; log using qDebug; messages are sent to the console, if it is a console application
#define ENABLE_SQTL_LOG_SINK_SIGNAL    0   // 1: enable, 0: disable; log forwarding by emitting a Qt signal
...
#define ENABLE_SQTL_LOG_LEVEL_FUNCTION   0   // 1: enable, 0: disable; stack-trace
...
void logInit(QString strLogDirectory);
